  ...
  return (
    <div className='p-3 lg:p-5'>
        ...
        <div className='mt-2 lg:mt-4 flex items-center justify-between'>
            <span className='bg-[#ccf0f3] text-iresBlurColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 rounded font-semibold'>
                {specialty}
            </span>
            ...
            <div className='flex items-center gap-[6px]'>
                ...
                <span className='text-[14px] leading-6 lg:text-[16px] lg:leadin-7 font-[400] text-textColor'>
                    ({totalRating})
                </span>
            </div>
        </div>
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
            <div>
                ...
                <p className='texty-[14px] leading-6 font-[400] text-textColor'>
                    At {hospital}
                </p>
            </div>
