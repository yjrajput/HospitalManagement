...
const navlinks = [
  ...
  
  {
    ...
    display: "Speciality",
    submenu: [
      { path: "/speciality/cardiology", display: "Cardiology" },
      { path: "/speciality/neurology", display: "Neurology" },
      { path: "/speciality/orthopedics", display: "Orthopedics" },
    ],
  },
  {
    path: "/services",
    display: "Services",
    submenu: [
      { path: "/services/consultation", display: "Consultation" },
      { path: "/services/diagnostics", display: "Diagnostics" },
      { path: "/services/emergency", display: "Emergency" },
    ],
  },
  {
    path: "/location",
